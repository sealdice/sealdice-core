...
type DeleteLogReq struct {
	Body request.RequestWrapper[DeleteLogReqBody] `json:"body"`
}
...
type UploadLogReq struct {
	Body request.RequestWrapper[UploadLogReqBody] `json:"body"`
}
...
type BackupBatchDeleteReq struct {
	Body request.RequestWrapper[BackupBatchDeleteReqBody] `json:"body"`
}
...
type CleanupReq struct {
	Body request.RequestWrapper[CleanupReqBody] `json:"body"`
}
