...
type FilenameReq struct {
	Body request.RequestWrapper[FilenameReqBody] `json:"body"`
}
...
type UpdateReq struct {
	Body request.RequestWrapper[UpdateReqBody] `json:"body"`
}
...
type UploadInitReq struct {
	Body request.RequestWrapper[UploadInitReqBody] `json:"body"`
}
...
type UploadCompleteReq struct {
	Body request.RequestWrapper[UploadCompleteReqBody] `json:"body"`
}
