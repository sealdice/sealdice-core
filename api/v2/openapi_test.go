...
func TestBuildOpenAPIIncludesCurrentV2Routes(t *testing.T) {
	...
	for _, path := range []string{
		...
		"/sd-api/v2/extension/packages",
		"/sd-api/v2/extension/packages/refresh",
		"/sd-api/v2/extension/asset",
		"/sd-api/v2/extension/config",
		"/sd-api/v2/extension/config-schema",
		"/sd-api/v2/extension/install-upload",
		"/sd-api/v2/extension/install-url",
		"/sd-api/v2/extension/preview-upload",
		"/sd-api/v2/extension/uninstall",
		"/sd-api/v2/extension/enable",
		"/sd-api/v2/extension/disable",
		"/sd-api/v2/extension/reload",
		"/sd-api/v2/extension/reload-content",
		"/sd-api/v2/extension/reload-all",
		"/sd-api/v2/extension/store/backends",
		"/sd-api/v2/extension/store/recommend",
		"/sd-api/v2/extension/store/page",
		"/sd-api/v2/extension/store/files/{namespace}/{package}/{version}",
		"/sd-api/v2/extension/store/file/{namespace}/{package}/{version}",
		"/sd-api/v2/extension/store/package-info-list",
		"/sd-api/v2/extension/store/preview-download",
		"/sd-api/v2/extension/store/download",
		"/sd-api/v2/extension/store/install-list",
		...
		"/sd-api/v2/imconnection/officialqq/test",
		...
		"/sd-api/v2/tool-test/split-options",
		"/sd-api/v2/pprof/cmdline",
		"/sd-api/v2/pprof/profile",
		"/sd-api/v2/pprof/trace",
		"/sd-api/v2/pprof/allocs",
		"/sd-api/v2/pprof/block",
		"/sd-api/v2/pprof/goroutine",
		"/sd-api/v2/pprof/heap",
		"/sd-api/v2/pprof/mutex",
		"/sd-api/v2/pprof/threadcreate",
	} {
