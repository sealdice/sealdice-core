...
func (s *Service) GetStatus(_ context.Context, _ *request.Empty) (*response.ItemResponse[helpdocm.StatusResp], error) {
	if s.dm.JustForTest {
		return response.NewItemResponse(helpdocm.StatusResp{Loading: false, TestMode: true}), nil
	}
	return response.NewItemResponse(helpdocm.StatusResp{Loading: s.dm.IsHelpReloading}), nil
}

func (s *Service) GetTree(_ context.Context, _ *request.Empty) (*response.ItemResponse[helpdocm.TreeResp], error) {
	if s.dm.JustForTest {
	...
	if s.dm.Help == nil {
		return response.NewItemResponse(helpdocm.TreeResp{Data: []*dice.HelpDoc{}}), nil
	}
	return response.NewItemResponse(helpdocm.TreeResp{Data: s.dm.Help.HelpDocTree}), nil
}

func (s *Service) Reload(_ context.Context, _ *request.Empty) (*response.ItemResponse[helpdocm.SimpleResp], error) {
	if s.dm.JustForTest {
		return response.NewItemResponse(helpdocm.SimpleResp{Success: false, TestMode: true}), nil
	}
	if s.dm.IsHelpReloading {
	...
	s.dm.InitHelp()
	return response.NewItemResponse(helpdocm.SimpleResp{Success: true}), nil
}

func (s *Service) Delete(_ context.Context, req *helpdocm.DeleteReq) (*response.ItemResponse[helpdocm.SimpleResp], error) {
	if s.dm.JustForTest {
		return response.NewItemResponse(helpdocm.SimpleResp{Success: false, TestMode: true}), nil
	}
	if s.dm.Help == nil {
	...
	if err := s.dm.Help.DeleteHelpDoc(req.Body.Body.Keys); err != nil {
		return nil, huma.Error500InternalServerError(err.Error())
	}
	return response.NewItemResponse(helpdocm.SimpleResp{Success: true}), nil
}

func (s *Service) GetItemsPage(_ context.Context, req *helpdocm.HelpTextItemQuery) (*response.ItemResponse[helpdocm.HelpTextItemPageResp], error) {
	if s.dm.Help == nil {
		return response.NewItemResponse(helpdocm.HelpTextItemPageResp{Data: dice.HelpTextVos{}}), nil
	}
	pageNum := req.PageNum
	if pageNum <= 0 {
		pageNum = 1
	...
	return response.NewItemResponse(helpdocm.HelpTextItemPageResp{
		Total:    total,
		Data:     data,
		PageNum:  pageNum,
		PageSize: pageSize,
...
func (s *Service) GetConfig(_ context.Context, _ *request.Empty) (*response.ItemResponse[helpdocm.ConfigResp], error) {
	if s.dm.IsHelpReloading {
		return nil, huma.Error409Conflict("帮助文档正在重新装载")
	}
	...
	return response.NewItemResponse(helpdocm.ConfigResp{Aliases: aliases}), nil
}

func (s *Service) SetConfig(_ context.Context, req *helpdocm.ConfigReq) (*response.ItemResponse[helpdocm.SimpleResp], error) {
	if s.dm.JustForTest {
		return response.NewItemResponse(helpdocm.SimpleResp{Success: false, TestMode: true}), nil
	}
	if s.dm.IsHelpReloading {
...
func (s *Service) InitUpload(_ context.Context, req *helpdocm.UploadInitReq) (*response.ItemResponse[helpdocm.HelpDocUploadSessionResp], error) {
	if s.dm.JustForTest {
		return response.NewItemResponse(helpdocm.HelpDocUploadSessionResp{Success: false, ResumeSupported: false}), nil
	}
	body := req.Body.Body
	...
	return response.NewItemResponse(helpdocm.HelpDocUploadSessionResp{
		Success:         true,
...
func (s *Service) GetUploadChunkStatus(_ context.Context, req *helpdocm.UploadChunkQuery) (*response.ItemResponse[helpdocm.HelpDocUploadChunkResp], error) {
	session, err := s.uploadManager.Get(req.SessionID)
	if err != nil {
		return nil, huma.Error404NotFound("上传会话不存在")
	}
	return response.NewItemResponse(helpdocm.HelpDocUploadChunkResp{
...
func (s *Service) UploadChunk(_ context.Context, req *helpdocm.UploadChunkReq) (*response.ItemResponse[helpdocm.HelpDocUploadChunkResp], error) {
	if s.dm.JustForTest {
		return response.NewItemResponse(helpdocm.HelpDocUploadChunkResp{Success: false, UploadedChunk: req.Index}), nil
	}
...
func (s *Service) CompleteUpload(_ context.Context, req *helpdocm.UploadCompleteReq) (*response.ItemResponse[helpdocm.HelpDocUploadCompleteResp], error) {
	if s.dm.JustForTest {
		return response.NewItemResponse(helpdocm.HelpDocUploadCompleteResp{Success: false, TestMode: true}), nil
	}
	if s.dm.Help == nil {
		return nil, huma.Error400BadRequest("帮助文档未初始化")
	}
	...
	session, err := s.uploadManager.CompleteWithoutCleanup(req.Body.Body.SessionID, tmpPath)
	if err != nil {
		switch {
	...
	s.uploadManager.Cleanup(req.Body.Body.SessionID)
	return response.NewItemResponse(helpdocm.HelpDocUploadCompleteResp{
		Success:  true,
