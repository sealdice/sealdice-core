...
- `format_version`: manifest format version as a semantic version string. The current version is `"1.0.0"`; omitted legacy manifests are treated as version `"1.0.0"`.
