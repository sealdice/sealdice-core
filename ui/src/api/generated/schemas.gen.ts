...
export const BodyJsCheckCronRespSchema = {
  additionalProperties: false,
  properties: {
    $schema: {
      description: 'A URL to the JSON Schema for this object.',
      examples: ['https://example.com/schemas/BodyJsCheckCronResp.json'],
      format: 'uri',
      readOnly: true,
      type: 'string',
    },
    item: {
      $ref: '#/components/schemas/JsCheckCronResp',
      description: '响应数据项',
    },
  },
  required: ['item'],
...
export const BodyNetworkHealthDataSchema = {
  additionalProperties: false,
  properties: {
    $schema: {
      description: 'A URL to the JSON Schema for this object.',
      examples: ['https://example.com/schemas/BodyNetworkHealthData.json'],
      format: 'uri',
      readOnly: true,
      type: 'string',
    },
    item: {
      $ref: '#/components/schemas/NetworkHealthData',
      description: '响应数据项',
    },
  },
  required: ['item'],
...
export const JsCheckCronReqBodySchema = {
  additionalProperties: false,
  properties: {
    $schema: {
      description: 'A URL to the JSON Schema for this object.',
      examples: ['https://example.com/schemas/JsCheckCronReqBody.json'],
      format: 'uri',
      readOnly: true,
      type: 'string',
    },
...
export const JsCheckCronRespSchema = {
  additionalProperties: false,
  properties: {
    valid: {
      type: 'boolean',
...
export const NetworkHealthDataSchema = {
  additionalProperties: false,
  properties: {
    ok: {
      description: '可连接目标列表',
    ...
    targets: {
      description: '逐目标检测结果',
      items: {
        $ref: '#/components/schemas/NetworkHealthTarget',
      },
      type: ['array', 'null'],
    },
    timestamp: {
  ...
  required: ['total', 'ok', 'targets', 'timestamp'],
  type: 'object',
} as const;

export const NetworkHealthTargetSchema = {
  additionalProperties: false,
  properties: {
    durationMs: {
      description: '平均延迟毫秒',
...
export const BodyJsCheckCronRespWritableSchema = {
  additionalProperties: false,
  properties: {
    item: {
      $ref: '#/components/schemas/JsCheckCronResp',
...
export const BodyNetworkHealthDataWritableSchema = {
  additionalProperties: false,
  properties: {
    item: {
      $ref: '#/components/schemas/NetworkHealthData',
...
export const JsCheckCronReqBodyWritableSchema = {
  additionalProperties: false,
  properties: {
    expr: {
      type: 'string',
