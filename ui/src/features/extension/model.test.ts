...
it('passes', async () => {
  ...
  assertDeepEqual(buildPackageFileTree([
    'reply/main.yaml',
    'reply/assets/icon.png',
    'scripts/index.js',
  ]), [
    {
      key: 'reply',
      ...
      children: [
        {
          ...
          kind: 'directory',
          children: [
            { key: 'reply/assets/icon.png', name: 'icon.png', path: 'reply/assets/icon.png', kind: 'file' },
          ],
        },
  ...
  assertDeepEqual(summarizeStoreInstallResult({
    items: [
