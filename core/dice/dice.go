...
type CmdItemInfo struct {
	...
	DisableExecuteTimesParse bool                      `jsbind:"disableExecuteTimesParse"` // 禁用执行次数解析，也就是不会再吃到3#这样的文本
