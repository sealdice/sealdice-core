...
func (p *DiceRollParser) Init(options ...func(*DiceRollParser) error) error {
	...
	_rules = [...]func() bool{
		...
		/* 6 eDice <- <((&(('d' / 'D') (number / '(')) ('d' / 'D') Action14 eDice2 ('k' eDice2 Action15)? ('q' eDice2 Action16)? Action17)+ / (eDice2 (('d' / 'D') Action18 &(number / '(') eDice2 ('k' eDice2 Action19)? ('q' eDice2 Action20)? Action21)*))> */
		func() bool {
		...
		/* 8 eDice2 <- <((('p' / 'P') laNumberOrLeftParen eDice3 Action22) / (('p' / 'P') Action23) / eDice3)> */
		func() bool {
		...
		/* 9 eDice3 <- <((('b' / 'B') laNumberOrLeftParen value Action24) / (('b' / 'B') Action25) / value)> */
		func() bool {
		...
		/* 10 value <- <(number / assign_expr / (identifier Action26) / sub)> */
		func() bool {
		...
		/* 12 assign_expr <- <(identifier Action28 '=' e1 Action29)> */
		nil,
		...
		nil,
		/* 45 Action18 <- <{ p.AddLeftValueMark() }> */
		nil,
		/* 46 Action19 <- <{ p.AddOperator(TypeDiceSetK) }> */
		nil,
		/* 47 Action20 <- <{ p.AddOperator(TypeDiceSetQ) }> */
		nil,
		/* 48 Action21 <- <{ p.AddOperator(TypeDice) }> */
		nil,
		/* 49 Action22 <- <{ p.AddOperator(TypeDicePenalty) }> */
		nil,
		/* 50 Action23 <- <{ p.AddValue("1"); p.AddOperator(TypeDicePenalty) }> */
		nil,
		/* 51 Action24 <- <{ p.AddOperator(TypeDiceBonus) }> */
		nil,
		/* 52 Action25 <- <{ p.AddValue("1"); p.AddOperator(TypeDiceBonus) }> */
		nil,
		/* 53 Action26 <- <{ p.AddLoadVarname(string(text)) }> */
		nil,
		nil,
		/* 55 Action27 <- <{ p.AddValue(string(text)) }> */
		nil,
		/* 56 Action28 <- <{ p.AddValueStr(string(text)) }> */
		nil,
		/* 57 Action29 <- <{ p.AddStore() }> */
		nil,
		/* 58 Action30 <- <{ p.AddFormatString(string(text)) }> */
		nil,
	}
	p.rules = _rules
	return nil
