...
- 不建议：如果你实在无法学会或不能使用其他方案，并且无法忍受<Badge type="tip" text="v1.4.5"/>版本的 BUG，可以在进行数据备份后从群文件或 [Github 仓库](https://github.com/sealdice/sealdice-build/releases/tag/beta-release)下载<Badge type="tip" text="v1.4.6-beta"/>版本海豹手动覆盖更新，此方法可能有不确定的风险，请用户谨慎选择。
