...
更复杂的自定义回复编写，会涉及到海豹提供的其他系统，如牌堆、内置脚本语法、变量机制等。也有可能要求你有其它知识的了解，如正则表达式等。如果你有复杂回复编写的需要，可以跳转到 [进阶 - 编写自定义回复](../advanced/edit_reply.md) 进行阅读。