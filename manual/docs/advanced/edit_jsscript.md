...
从 <Badge type="tip" text="v1.4.5" vertical="middle"/> 起，在私聊中，除了**骰主**和**黑名单用户**，其他用户被视为拥有与群管理员等同的权限，即权限值 50。

在 <Badge type="danger" text="v1.4.4" vertical="middle"/> 或更早版本，私聊中除了**骰主**和**黑名单用户**，其他用户的权限等级为普通用户（0）。
